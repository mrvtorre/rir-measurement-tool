...
def _parse():
    ...
    parser.add_argument(
        ...
        "--fs",
        type=int,
        help=" The sampling rate (make sure it matches that of your audio interface). Default: 44100 Hz.",
        default=defaults["fs"],
    )
    # ---
    parser.add_argument(
        ...
        "--duration",
        type=int,
        help=" The duration of a single sweep. Default: 15 seconds.",
    ...
    parser.add_argument(
        ...
        "--reps",
        type=int,
        help="Number of repetitions of the sinesweep. Default: 1.",
    ...
    parser.add_argument(
        ...
        "--amplitude",
        type=float,
        help="Amplitude of the sine. Default: 0.7",
    ...
    parser.add_argument(
        ...
        "--startsilence",
        type=int,
        help="Duration of silence at the start of a sweep, in seconds. Default: 1.",
        default=defaults["startsilence"],
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        help="Frequency range of the sweep",
        default=defaults["sweeprange"],
    )
    # ---
    parser.add_argument(
        "-es",
        "--endsilence",
        type=int,
        help="Duration of silence at the end of a sweep, in seconds. Default: 1.",
        default=defaults["endsilence"],
    )
    # ---
    parser.add_argument(
        "-chin",
        ...
        nargs="+",
        type=int,
        help="Input channel mapping",
        default=defaults["inputChannelMap"],
    )
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        help="Output channel mapping",
        default=defaults["outputChannelMap"],
    )
    ...
    parser.add_argument(
        ...
        default=defaults["inputdevice"],
    )

    parser.add_argument(
        "--listdev",
        help="List the available devices, indicating the default one",
        action="store_true",
    )

    parser.add_argument(
        "--defaults",
        help="List the default measurement parameters (devices, channels, and signal properties)",
        action="store_true",
    )

    parser.add_argument(
        "--setdev",
        help="Use this keyword in order to change the default audio interface.",
        action="store_true",
    )
